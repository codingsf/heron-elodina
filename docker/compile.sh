...
pack_topology() {
    ...
    bazel build //contrib/kafka9/examples/src/java:streaming-library-demo_deploy.jar
    ...
    cp ./bazel-bin/contrib/kafka9/examples/src/java/streaming-library-demo_deploy.jar /dist/topologies
}
